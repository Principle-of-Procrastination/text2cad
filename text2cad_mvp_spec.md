...
- 状态：Draft / 新实现基线
- 更新日期：2026-07-17
- 目标 CAD：SOLIDWORKS 2026 x64（MVP 唯一支持版本）
...
- Windows 11 x64。
- SOLIDWORKS 2026 x64 与同版本 API SDK/Primary Interop Assemblies。
...
SOLIDWORKS 2026 的官方 C# Add-in 通过 .NET Framework PIA、COM、`ISwAddin` 和 `RegAsm` 加载。Add-in 以 .NET Framework 4.8 为目标，并使用本机 SOLIDWORKS 2026 的同版本 PIA。Add-in 必须足够薄、稳定，并与 SOLIDWORKS 的线程和生命周期一致。
...
- 专用 Windows 11 + SOLIDWORKS 2026 runner，运行 M0/M1、负向和恢复用例。
- 固定模板、语言、单位、configuration 和 golden models。
- 执行后保存并重开，断言特征类型、尺寸、质量属性、rebuild 错误和 Undo 状态。
- 每次回归都记录 SOLIDWORKS 2026 service pack、Interop 来源和文件版本。
...
- [SOLIDWORKS C# Add-in Applications](https://help.solidworks.com/2026/english/api/sldworksapiprogguide/GettingStarted/Visual_C__Standalone_and_Add-in_Applications.htm)
- [ISwAddin 与注册要求](https://help.solidworks.com/2026/English/api/sldworksapiprogguide/Overview/Using_SwAddin_to_Create_a_SolidWorks_Addin.htm)
...
- [StartRecordingUndoObject](https://help.solidworks.com/2026/English/api/sldworksapi/SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDocExtension~StartRecordingUndoObject.html)
- [FinishRecordingUndoObject2](https://help.solidworks.com/2026/english/api/sldworksapi/SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDocExtension~FinishRecordingUndoObject2.html)
- [EditUndo2](https://help.solidworks.com/2026/english/api/sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~EditUndo2.html)
